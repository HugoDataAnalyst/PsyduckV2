...
store_sql_pokemon_aggregation = config.get('SQL', {}).get('use_sql_pokemon_aggregation', True)
store_sql_pokemon_shiny = config.get('SQL', {}).get('use_sql_pokemon_shiny', True)
