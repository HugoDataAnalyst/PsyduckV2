...
class PokemonIVDailyPartitionEnsurer:
    def __init__(
        self,
    ...
    async def _run_once(self, tag: str):
        try:
            ...
            logger.error(f"❌ [{tag}] partition ensure failed: {e}", exc_info=True)
    ...
    async def start(self):
        ...
        logger.info("🚀 Daily partition ensurer started.")
    ...
    async def stop(self):
        ...
        try:
            ...
            pass
        logger.info("🛑 Daily partition ensurer stopped.")
